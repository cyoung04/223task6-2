    ...
    stages{
        ...
        stage("Unit and Integration Tests"){
            ...
            post{
                success{
                    script{
                        emailext attachlog: true, compressLog: true, body: "Unit and Integration tests were successful", subject: "Tests Status Email", to: "cyoung1902@gmail.com"
                        //to: "cyoung1902@gmail.com",
